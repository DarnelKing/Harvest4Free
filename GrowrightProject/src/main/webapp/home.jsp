...
<head>
  ...
  <script language="javascript" type="text/javascript">
     ...
     function healthB(){
         window.open("healthbenefits.jsp","_self");
     }
     function receipes(){
         window.open("Recepies.jsp","_self");
     }
  ...
  <section>
    ...
    <div class= "subhead">
      ...
      <div class= "requirements" id=recipes style="order:1">
        ...
        <a href="#recipes" onclick="receipes()"><h1>RECIPES</h1></a>
      ...
      <a href="#healthbenefit" onclick="healthB()"><h1>HEALTH BENEFITS</h1></a>
